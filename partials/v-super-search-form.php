    ...
    <div class="ys-v-row-item">
        ...
        <div class="ys-v-row-item">
            ...
            <div style="height: 100px; overflow-y: scroll;">
                <label><input type="checkbox" name="condition" value="" style='width: auto;'> Any</label>
        ...
        <div class="ys-v-row-item">
            ...
            <div style="height: 200px; overflow-y: scroll;">
                <?php 
                    echo "<label><input type='checkbox' name='staterooms' value='' style='width: auto;'> All Builders</label>";
        ...
        <div class="ys-v-row-item">
            ...
            <div style="height: 100px; overflow-y: scroll;">
                <?php 
                    echo "<label><input type='checkbox' name='staterooms' value='' style='width: auto;'> All Hulls</label>";
        ...
        <div class="ys-v-row-item">
            ...
            <div style="height: 100px; overflow-y: scroll;">
                <?php 
                    echo "<label><input type='checkbox' name='staterooms' value='' style='width: auto;'> Any</label>";
        ...
        <div class="ys-v-row-item">
            ...
            <div style="height: 100px; overflow-y: scroll;">
                <?php 
                    echo "<label><input type='checkbox' name='staterooms' value='' style='width: auto;'> All Types</label>";
